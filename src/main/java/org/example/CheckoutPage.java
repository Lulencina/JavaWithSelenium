...
public class CheckoutPage {
    ...
    public void enterStreetAdress(String streetAdress) {driver.findElement(streetAdressSelect).sendKeys(streetAdress);}
    ...
    public void enterZip(String zip) {driver.findElement(zipField).sendKeys(zip);}

    public void enterPhone(String phone) {driver.findElement(phoneField).sendKeys(phone);}
    ...
    public void clickProceedToPay() {driver.findElement(proceedToPayBtn).click();}
}
